...
with st.sidebar.expander("Mined member-layer packs (elims / 1-miss downranks / rescues)", expanded=False):
    ...
    st.caption("Overlay CSV supports legacy row-memory columns plus seed/combo predicates: contains-digit, sum/mod/root, spread, high/low counts, V-trac group count, digit-count sets, and positional digit pools. See updated template CSV.")
