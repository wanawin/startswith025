#!/usr/bin/env python3
# BUILD: core025_master_goal_lab__2026-04-19_v5_separation_first_defaults
...
BUILD_MARKER = "BUILD: core025_master_goal_lab__2026-04-19_v5_separation_first_defaults"
APP_VERSION_STR = "core025_master_goal_lab__2026-04-19_v5_separation_first_defaults"
...
st.warning("v5 is separation-first: stronger tie handling, Top2 proximity bias, and stream pruning before final decisions. Nothing runs until you click a Run button.")
...
with tab_lab:
    st.subheader("Lab walk-forward + separation-first decision control")
    c1, c2, c3, c4 = st.columns(4)
